...
net_dict = {
    ...
    'connect_probs':
        np.array([
                [0.656, 0., 0.024, 0.279, 0., 0., 0., 0.241, 0., 0.017, 0., 0.203, 0., 0., 0., 0., 0.], # L1VIP
    ...
    'proportion_NMDA': 0.2,
    # There is only one synaptic delay in Giulia column model, 2*ms
    'delay' : 2.*ms,
    ...
    'bg_rate':
        np.array([650., 930., 1460., 870., 1410., 890., 1980., 2100., 220., 4730., 930., 530., 870., 1770., 1170., 890., 1630.])*Hz,
...
eqs_dict = {
    ...
    'eqs_neuron': Equations('''
        ...
        I_ampa_rec = g_ampa_rec*(v - V_E)*s_ampa_tot : amp
