...
The folder 'IMAGES' will contain the figures generated by the jupyter notebooks. There the folder 'images paper' contains the final 7 figures.
The folder 'simulations_data' contains all the data that you need in order to generate the figures. 
These data were obtained by running simulations with the main 3 codes (see below).  
