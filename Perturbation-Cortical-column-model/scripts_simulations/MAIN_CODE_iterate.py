...
pops[1][0][:].I_ext=-30 * pA # This is the FF state
...
pops[LAYER][CELL_TYPE][:].I_ext=-30 * pA 
if LAYER==1 and CELL_TYPE==0:
    pops[1][0][:].I_ext=-60 * pA
