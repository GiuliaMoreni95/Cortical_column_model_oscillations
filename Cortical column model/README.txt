...
The folder 'IMAGES' will contain the figures generated by the jupyter notebooks. Inside the folder 'images paper' contains the final 7 figures.
The folder 'simulations_data' contains all the data that you need in order to generate the figures. 
These data were obtained by running simulations with the main 3 codes (see below). The results of the simulations are saved there. 
I created a zip file of this folder, download the current project and unzip.
