...
a='Cont/Spikes_files_30pA' #This is the folder taht will contain the spikes
rest_file='network_state_first_nowe'
#b='weights_files_30pA' #This is the folder taht will contain the rates
# In[5]:


######Parameters to change in the simulation######
t_cont=3
runtime = (t_cont*1000.0) * ms
dt_sim=0.1 #ms
...
print('Start Simulation restored')
net.restore(filename=rest_file)
pops[1][0][:int(N[1][0]/2)].I_ext=-30 * pA
...
def save_lfp_rec(num,igabaE23,iampaE23,inmdaE23,iampaextE23,igabaE4,iampaE4,inmdaE4,iampaextE4,igabaE5,iampaE5,inmdaE5,iampaextE5,igabaE6,iampaE6,inmdaE6,iampaextE6):
    #layer 2/3
    igabaE23_save=[]
    iampaE23_save=[]
    inmdaE23_save=[]
...
#save_lfp_rec(num,igabaE23,iampaE23,inmdaE23,iampaextE23,igabaE4,iampaE4,inmdaE4,iampaextE4,igabaE5,iampaE5,inmdaE5,iampaextE5,igabaE6,iampaE6,inmdaE6,iampaextE6)
...
# xlabel('Time (ms)')
# show()
# fig.savefig('ampa_syn.png')

# In[34]:


#
# f=open("weights_files/w_ampa0.txt",'w+') #create the file
# for i in range(0,len(M.w_AMPA[0])):
#     f.write('%i ' %M.w_AMPA[0][i])
#     f.write('\n')
# f.close()
# f=open("weights_files/w_ampa1.txt",'w+') #create the file
# for i in range(0,len(M.w_AMPA[1])):
#     f.write('%i ' %M.w_AMPA[1][i])
#     f.write('\n')
# f.close()
# f=open("weights_files/w_ampa2.txt",'w+') #create the file
# for i in range(0,len(M.w_AMPA[2])):
#     f.write('%i ' %M.w_AMPA[2][i])
#     f.write('\n')
# f.close()
# f=open("weights_files/w_ampa3.txt",'w+') #create the file
# for i in range(0,len(M.w_AMPA[3])):
#     f.write('%i ' %M.w_AMPA[3][i])
#     f.write('\n')
# f.close()
